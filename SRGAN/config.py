...
# Schedulers
scheduler_D = StepLR(optimizer_D, epochs // 2, 0.1)        # Discriminator model scheduler during adversarial training.
scheduler_G = StepLR(optimizer_G, epochs // 2, 0.1)        # Generator model scheduler during adversarial training.
